...
// Group kind 30 uses flags bit 31 for brightness and bit 30 for grayscale;
// stroke_width carries the bounded non-negative amount. A zero flag retains
// the opacity-group alpha stored in the low byte of rgba.
