...
public:
    ...
    using file_grant_create_directory_request_sink_v2 = std::function<bool(
        const webscene_file_grant_create_directory_request_v2&)>;
    using file_grant_remove_request_sink_v2 =
        std::function<bool(const webscene_file_grant_remove_request_v2&)>;
    ...
    void complete_file_grant_create_directory_request(
