...
The ARM64 command creates a cross-build stage. CI transfers that stage to an
x64 runner with ARM64 emulation and calls the same command with `--stage finalize`
to create the V8 bootstrap snapshot, execute tests, and pack the NuGet package. Published
